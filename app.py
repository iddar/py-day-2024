...
class WhereIsTheBallGame:
    ...
    def on_cell_click(self, idx):
        ...
        if idx == self.ball_position:
            game_floem.update_message("¡Felicitaciones! ¡Encontraste la bolita!")
        else:
           game_floem.update_message("¡Lo siento! La bolita no estaba ahí.")
...
if __name__ == "__main__":
    try:
        game = WhereIsTheBallGame(num_cups=3)
        game.start()
